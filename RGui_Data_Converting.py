...
# Form implementation generated from reading ui file 'RGui_Data_Converting.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(881, 1034)
        self.frame = QtWidgets.QFrame(Dialog)
        self.frame.setGeometry(QtCore.QRect(10, 10, 861, 1011))
        ...
        self.gridLayout.addLayout(self.horizontalLayout_39, 4, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Final Data Converting To Excel Format Option"))
        self.label.setText(_translate("Dialog", "Screening Data File Name:"))
        self.label_2.setText(_translate("Dialog", "Directory to Convert Data To:"))
